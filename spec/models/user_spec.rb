...
describe User do
  ...
  it "should create a new instance given valid attributes", :chapter6 => "true" do
	  User.create!(@attr)
  end
  ...
  describe "password encryption" do
	  ...
	  it "should set the encrypted password", :chapter7 => "true" do
		  @user.encrypted_password.should_not be_blank
	  end

	  describe "has_password? method" do

		  it "should be true if the passwords match", :chapter7 => "true" do
			  @user.has_password?(@attr[:password]).should be_true
		  end

		  it "should be false if the passwords don't match", :chapter7 => "true" do
	  ...
	  describe "authenticate method" do
		  ...
		  it "should return the suer on email/passord match", :chapter7 => "true" do
